    ...
    <div>
            <header>
                    <div class="main">
                        ...
                        <li><a href="dataMC.php"  class="current">Data Mesin Cuci</a></li>
                        ...
                        <table class="fixed-th">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <button> 
                                            <a href="editDataMC.php?id=<?php echo $row['id_mc']; ?>"> Edit </a>
                                    </button></td>
                                    <td> <button> 
                                            <a href="hapusDataMC.php?id=<?php echo $row['id_mc']; ?>"> Hapus </a>
                                    </button></td>
                                <?php
                                        }
                                    }
